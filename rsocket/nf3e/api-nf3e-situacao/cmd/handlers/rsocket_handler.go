...
type Nf3eSituacaoHandler interface {
	GetNf3eSituacao(msg payload.Payload) (entities.Nf3eSituacao, error)
}
...
func (services *nf3eSituacaoHandler) GetNf3eSituacao(msg payload.Payload) (entities.Nf3eSituacao, error) {
...
func JsonUnmarshal(payload string) dtos.ConsSitNF3e {
	...
	if err != nil {
		log.Println("Erro ao pegar a o payload")
	}
