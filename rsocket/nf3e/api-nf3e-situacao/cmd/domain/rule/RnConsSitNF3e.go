...
/*
	Validar se o Tipo do ambiente informado difere do ambiente do Web Service
*/
func (e *ConsSitNF3e) rnI01Rej252() RespostaValidacao {
	...
	if e.TpAmb != config.AppConfig.TpAmb {
		resp.CStat = "252"
...
/*
	Validar UF da chave de acesso difere da UF do Web Service
*/
func (e *ConsSitNF3e) rnI02Rej226() RespostaValidacao {
	...
	if e.ChNF3eDecode.Cuf != config.AppConfig.CUF {
		resp.CStat = "226"
...
func (e *ConsSitNF3e) rnI04Rej236() RespostaValidacao {
	...
	var cnpj = model.Cnpj{Value: e.ChNF3eDecode.Cnpj}
