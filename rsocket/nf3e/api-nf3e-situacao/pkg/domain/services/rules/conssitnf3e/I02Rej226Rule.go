...
type rnI02Rej226Rule struct {
	ConsSitNF3e entities.ConsSitNF3e
}

func NewRnI02Rej226(consSitNF3e entities.ConsSitNF3e) ports.RulePort {
	return &rnI02Rej226Rule{ConsSitNF3e: consSitNF3e}
}

func (r *rnI02Rej226Rule) Validate() entities.ResultadoProcessamento {
